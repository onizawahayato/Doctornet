            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('Admin\NetController@update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="Symptom name">症状名</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="Symptom name" value="{{ $net_form->Symptom name }}">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="row mt-5">
                    <div class="col-md-4 mx-auto">
                        <h2>編集履歴</h2>
                        <ul class="list-group">
                            @if ($net_form->histories != NULL)
                                @foreach ($net_form->histories as $history)
